      ...
      <div className="footer-container">
            <div className="footer-row">
                <div className="footer-col">
                    <h4>Contact Info</h4>
                    <h5>Hospital CMS Office, <br/> National Health Authority, New Delhi - 110001 <br/>Email: <a href="mailto:Hospital@nha.gov.in">Hospital@nha.gov.in</a><br/> Toll Free No. 1800-11-4477</h5>
                    </div>
                    <div className="footer-col">
                    <h4>Get Help</h4>
                    <ul>
        ...
        <div className="copyright">
            <p>Copyright © 2023 All Rights Reserved <br/> Website Content Verified by Hospital Team - International Institute of Information Technology, Bangalore.</p>
        </div>
    </div>
  )
}
